                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-md-12 col-lg-6 col-xl-5">
                                    ...
                                    <table className="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className="py-5">
                                                    <h5><p className="mb-0 text-dark text-uppercase py-3">Tổng tiền</p></h5>
                                                </td>
                                                <td className="py-5"></td>
                                                <td className="py-5"></td>
                                                <td className="py-5">
                                                    <div className="py-3 border-bottom border-top">
                                                       <h5> <p className="mb-0 text-dark">{totalPrice}</p></h5>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div className="row g-4 text-center align-items-center justify-content-center pt-4">
                                    <h3><button onClick={handlePayment} type="button" className="btn border-secondary py-3 px-4 text-uppercase w-100 text-primary">Thanh toán đơn hàng </button></h3>
                                </div>
                                <br />
