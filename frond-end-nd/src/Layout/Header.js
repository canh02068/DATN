                                ...
                                <a href="/" className="dropdown-toggle lnk-cart" data-toggle="dropdown">
                                    <div className="items-cart-inner">
                                        <div className="basket">
                                            ...
                                            <div className="total-price-basket"> <span className="lbl" onClick={() => navige(`giohang`)}>Giỏ Hàng</span>{totalPrice.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })} <span className="value">{ }</span> </div>
                                        </div>
                                    </div>
                                </a>
                            </div>
