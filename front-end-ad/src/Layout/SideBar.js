            ...
            <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <li className="nav-item">
                    <Link className="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                        ...
                        <div className="sidebar-brand-text mx-3">Admin<sup>tc</sup></div>
                    </Link>
                </li>
                ...
                <li className="nav-item">
                    <Link className="nav-link" href="index.html">
                        ...
                        <span>Quản lý mỹ phẩm xách tay</span>
                    </Link>
                </li>
                ...
                {/* Heading */}
                <li className="sidebar-heading">Mỹ phẩm xách tay</li>
                ...
                {/* Heading */}
                <li className="sidebar-heading">Quản lí</li>
