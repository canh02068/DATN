                ...
                <Modal.Body>
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea type="text" value={congDung} onChange={(event) => setCongDung(event.target.value)} class="form-control" id="inputPassword4" />
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea type="text" value={moTa} onChange={(event) => setMoTa(event.target.value)} class="form-control" id="inputPassword4" />
                        </div>
